...
export default function StudentAssignments() {
  ...
  const handleSubmit = async (assignment: any) => {
    ...
    try {
      ...
      if (
        searchParams?.get("taskId") === assignment.id &&
        assignment.courseId
      ) {
        setOpenTaskId(null);
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2">
                  <Avatar className="w-6 h-6">
                    <AvatarImage
                      src={
                        assignment.instructorAvatar || generateRandomAvatar()
                      }
                    />
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-white">{assignment.score ?? 0} pts</p>
                  </div>
                </div>
              </>
            )}
                ...
                <>
                  ...
                  {assignment.githubUrl && (
                    <Button
                      ...
                      className="border-white/20 text-white hover:bg-white/10 bg-transparent"
                      onClick={() =>
                        window.open(assignment.githubUrl, "_blank")
                      }>
