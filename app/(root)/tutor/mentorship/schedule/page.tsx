      ...
      <div className="container mx-auto px-6 space-y-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-secondary">
            Create and manage mentorship offerings. Link them to your courses to
            suggest to course completers or keep them standalone.
          </p>
        </div>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription className="text-secondary">
                Create a new mentorship offering that students can book. You can
                link it to one of your courses or keep it standalone.
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleCreateOffering} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-secondary">
                  Linking to a course will allow you to upsell mentorship to
                  students who complete that course.
                </p>
              </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-center text-muted-foreground">
                Loading your mentorship offerings...
              </p>
            </CardContent>
          </Card>
        )}
                  ...
                  <CardContent className="flex-1 space-y-3">
                    ...
                    <div className="flex gap-2 pt-2">
                      <Button
                        ...
                        onClick={() =>
                          router.push(
                            `/tutor/mentorship/offering/${offering.id}`,
                          )
                        }>
                        View Details
                      </Button>
              ...
              <div className="text-center space-y-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg">
                    No Mentorship Offerings Yet
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Create your first mentorship offering to start accepting
                    bookings from students.
                  </p>
                </div>
        ...
        <Card className="">
          ...
          <CardContent>
            <p className="text-sm text-white">
              Link mentorship offerings to your courses to create an upsell
              opportunity. When students complete a course, they'll see
              suggestions for mentorship sessions to deepen their mastery. This
              helps you generate additional revenue while providing more value
              to your students.
            </p>
          </CardContent>
        </Card>
