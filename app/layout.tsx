...
export default async function MainRootLayout({
  ...
  // The nonce proxy.ts minted for this request. Next stamps it onto its own
  // bundles automatically, but a <Script> only gets it when passed explicitly,
  // and without it the CSP blocks these three outright.
      ...
      <html lang="en" suppressHydrationWarning>
        ...
        <body
          ...
          <ThemeProvider
            ...
            // next-themes injects an inline script that sets the theme before
            // first paint. Under a nonce CSP it is blocked without this, and
            // the page paints the wrong theme before React corrects it.
            nonce={nonce}>
          ...
          */}
          ...
          {process.env.NEXT_PUBLIC_FACEBOOK_PIXEL_ID && (
            <Script id="facebook-pixel" nonce={nonce} strategy="lazyOnload">
              {`
          ...
          {process.env.NEXT_PUBLIC_MIXPANEL_TOKEN && (
            <Script id="mixpanel-init" nonce={nonce} strategy="lazyOnload">
              {`
