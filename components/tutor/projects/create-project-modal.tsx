...
import { createProject, getTutorCoursesForProjects } from "@/actions/project";
...
export function CreateProjectModal({
  ...
  const form = useForm<ProjectFormData>({
    resolver: zodResolver(projectSchema) as any, // quick fix for type mismatch
    defaultValues: {
      title: "",
      description: "",
      requirements: [],
  ...
  useEffect(() => {
    if (open) {
      getTutorCoursesForProjects().then((result) => {
        if (result.courses) {
  ...
  const addResource = () => {
    if (currentResource.title.trim() && currentResource.url.trim()) {
      const newResource = {
        ...
        description: currentResource.description || undefined,
        url: currentResource.url,
        type: currentResource.type as
          | "PDF"
          | "VIDEO"
          | "AUDIO"
          | "IMAGE"
          ...
          | "CODE"
          | "DOCUMENT",
        isPublic: currentResource.isPublic,
      };
      const newResources = [...resources, newResource];
      setResources(newResources);
      form.setValue("resources", newResources as any);
      setCurrentResource({
        title: "",
        description: "",
        url: "",
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-background border-white/10">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400">
            Create a course capstone project. Students will submit their work
            for review.
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <FormDescription className="text-gray-400">
                Add helpful resources like documentation, links, or files for
                students
              </FormDescription>
                  ...
                  {resources.map((resource, index) => (
                    <div
                      ...
                      <div className="flex items-center space-x-3 flex-1">
                        <LinkIcon className="w-4 h-4 text-neon-blue flex-shrink-0" />
                        <div className="flex-1 min-w-0">
                          ...
                          <a
                            ...
                            className="text-neon-blue text-xs hover:underline truncate block">
                            {resource.url}
                          </a>
                        </div>
                      </div>
