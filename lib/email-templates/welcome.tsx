            ...
            <Container className="w-full mx-auto max-w-2xl">
              ...
              <Section className="bg-white px-8 py-8">
                ...
                <Text className="text-base text-gray-700 mb-4 leading-relaxed">
                  Welcome to <b>PalmTechnIQ</b>! We're absolutely thrilled to
                  have you join our learning community. You've taken the first
                  step toward unlocking your potential and advancing your
                  career.
                </Text>

                <Text className="text-base text-gray-700 mb-4 leading-relaxed">
                  You chose PalmTechnIQ because you're eager for knowledge and
                  ready to explore new horizons. That's exactly the kind of
                  energy we love to see! You're now part of a community of
                  learners, mentors, and tutors committed to continuous growth
                  and excellence.
                </Text>
